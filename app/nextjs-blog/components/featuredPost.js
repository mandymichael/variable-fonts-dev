        ...
        <section className={PostListStyles.section}>
          ...
          <article className={PostListStyles.featuredPost}>
              <div className={PostListStyles.featuredPostContent}>                         
                ...
                <Link href={`/posts/${featuredPost[0].id}`} className={PostListStyles.cardImageMobile}><Image className={PostListStyles.image} width="904" height="495" src={featuredPost[0].card ? featuredPost[0].card.featured : '/images/post-assets/cards/default.jpg'} alt={featuredPost[0].card ? featuredPost[0].card.cardAlt : 'default post image'} /></Link>
