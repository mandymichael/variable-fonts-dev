    ...
    getPageList() {
        if (process.env.NODE_ENV === "production") {
            ...
            if (window.__DEV_PAGES_MANIFEST) {
                ...
                this.promisedDevPagesManifest || (this.promisedDevPagesManifest = fetch(this.assetPrefix + "/_next/static/development/" + DEV_CLIENT_PAGES_MANIFEST).then((res)=>res.json()).then((manifest)=>{
        ...
        if (process.env.NODE_ENV === "production") {
            ...
            if (window.__DEV_MIDDLEWARE_MATCHERS) {
                ...
                if (!this.promisedMiddlewareMatchers) {
                    ...
                    // @ts-ignore
                    this.promisedMiddlewareMatchers = fetch(this.assetPrefix + "/_next/static/" + this.buildId + "/" + DEV_MIDDLEWARE_MANIFEST).then((res)=>res.json()).then((matchers)=>{
