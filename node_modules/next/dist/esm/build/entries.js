...
export function getEdgeServerEntry(opts) {
    var _opts_config_experimental_sri, _opts_config_experimental_serverActions;
    ...
    const loaderParams = {
        ...
        preferredRegion: opts.preferredRegion,
        middlewareConfig: Buffer.from(JSON.stringify(opts.middlewareConfig || {})).toString("base64"),
        serverActionsBodySizeLimit: (_opts_config_experimental_serverActions = opts.config.experimental.serverActions) == null ? void 0 : _opts_config_experimental_serverActions.bodySizeLimit
    };
    return {
