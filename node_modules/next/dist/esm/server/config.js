...
function assignDefaults(dir, userConfig, silent) {
    ...
    if (((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.ppr) && !version.includes("canary")) {
        Log.warn(`The experimental.ppr feature is present in your current version but we recommend using the latest canary version for the best experience.`);
    }
