...
async function getBarrelMapping(layer, resourcePath, swcCacheDir, resolve, fs) {
    ...
    async function transpileSource(filename, source, isWildcard) {
        ...
        return new Promise((res)=>(0, _swc.transform)(source, {
                ...
                serverComponents: {
                    isReactServerLayer: layer === _constants.WEBPACK_LAYERS.reactServerComponents
                },
                jsc: {
                    parser: {
...
const NextBarrelLoader = async function() {
    ...
    const mapping = await getBarrelMapping((_this__module = this._module) == null ? void 0 : _this__module.layer, this.resourcePath, swcCacheDir, resolve, this.fs);
