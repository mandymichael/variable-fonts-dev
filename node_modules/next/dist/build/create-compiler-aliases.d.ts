...
export declare function createWebpackAliases({ isClient, isEdgeServer, isNodeServer, dev, config, pagesDir, appDir, dir, reactProductionProfiling, hasRewrites, }: {
    isClient: boolean;
...
export declare function createServerComponentsNoopAliases(): CompilerAliases;
export {};
